 ...
 * Description:       Create WC Coupons Based On User Role / Block Certain Coupon for Selected User Roles.
 * Version:           0.2
...
class WC_User_Role_Based_Coupon {
    ...
    public function get_registered_roles(){
        ...
        $user_roles['logedout'] = array('name' => __('Visitor / LogedOut User',WC_URBC_TXT));  
        return $user_roles;
    }  
