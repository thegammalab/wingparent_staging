...
if (!class_exists('Tax_Meta_Class')) :
    ...
    class Tax_Meta_Class {
        ...
        public function load_scripts_styles() {
            ...
            // Get Plugin Path
            $plugin_path = get_template_directory_uri() . "/framework/tax-meta-class";
...
.at-repater-block{background-color: #FFFFFF;border: 1px solid;margin: 2px;}
      ...
      <a class='at-add-file button' href='#'>" . __('Add more files', 'tax-meta') . "</a>\n
        ...
        public function show_field_checkbox_list($field, $meta) {
            ...
            foreach ($field['options'] as $key => $value) {
                $html[] = "<input style='{$field['style']}' type='checkbox' class='at-checkbox_list' name='{$field['id']}[]' value='{$value}'" . checked(in_array($value, $meta), true, false) . " /> {$value}";
            }
